...
@Component({
  selector: 'cm-dddlayer-details',
  templateUrl: 'dddlayer-details.component.html',
  styleUrls: [ 'dddlayer-details.component.css' ]
})
export class DDDLayerDetailsComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      this.route.parent.params.subscribe((params: Params) => {
        let id = +params['id'];
        this.dataService.getDDDLayer(id)
            .subscribe((dddlayer: IDDDLayer) => {

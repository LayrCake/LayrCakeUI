...
@Component({
  selector: 'cm-dddsolutiontopackagelink-details',
  templateUrl: 'dddsolutiontopackagelink-details.component.html',
  styleUrls: [ 'dddsolutiontopackagelink-details.component.css' ]
})
export class DDDSolutionToPackageLinkDetailsComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      this.route.parent.params.subscribe((params: Params) => {
        let id = +params['id'];
        this.dataService.getDDDSolutionToPackageLink(id)
            .subscribe((dddsolutiontopackagelink: IDDDSolutionToPackageLink) => {

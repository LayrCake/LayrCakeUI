...
@Component({
    selector: 'cm-problemdomainsolutionlink-list',
	templateUrl: 'problemdomainsolutionlink-list.component.html',
...
export class ProblemDomainSolutionLinkListComponent {
    public data;
    public filterQuery = "";
    ...
    ngOnInit(): void {
        this.dataService.getProblemDomainSolutionLinks()
            .subscribe((result) => {
                setTimeout(() => {
                    this.data = result;
                }, 1000);

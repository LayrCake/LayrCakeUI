...
@Component({
    selector: 'cm-dddpackagetopackagelink-list',
	templateUrl: 'dddpackagetopackagelink-list.component.html',
...
export class DDDPackageToPackageLinkListComponent {
    public data;
    public filterQuery = "";
    ...
    ngOnInit(): void {
        this.dataService.getDDDPackageToPackageLinks()
            .subscribe((result) => {
                setTimeout(() => {
                    this.data = result;
                }, 1000);

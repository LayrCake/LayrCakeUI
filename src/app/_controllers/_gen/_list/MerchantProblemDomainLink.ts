...
@Component({
    selector: 'cm-merchantproblemdomainlink-list',
	templateUrl: 'merchantproblemdomainlink-list.component.html',
...
export class MerchantProblemDomainLinkListComponent {
    public data;
    public filterQuery = "";
    ...
    ngOnInit(): void {
        this.dataService.getMerchantProblemDomainLinks()
            .subscribe((result) => {
                setTimeout(() => {
                    this.data = result;
                }, 1000);

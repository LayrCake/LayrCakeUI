...
@Component({
    selector: 'cm-dddlayertemplate-list',
	templateUrl: 'dddlayertemplate-list.component.html',
...
export class DDDLayerTemplateListComponent {
    public data;
    public filterQuery = "";
    ...
    ngOnInit(): void {
        this.dataService.getDDDLayerTemplates()
            .subscribe((result) => {
                setTimeout(() => {
                    this.data = result;
                }, 1000);
